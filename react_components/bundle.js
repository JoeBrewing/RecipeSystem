...
/***/ function(module, exports, __webpack_require__) {
	...
	var HopBox = __webpack_require__(1)
	var GrainBox = __webpack_require__(2)
	var YeastBox = __webpack_require__(3)
	      ...
	      React.createElement("div", {className: "mainBox"}, 
	        React.createElement("div", {className: "container-fluid"}, 
	          React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-xs-11"}, 
	                  React.createElement("div", {className: "well"}, 
	                      React.createElement("h3", null, "Hops"), 
	                      React.createElement("span", {className: "help-block"}, "Enter the hop type, amount, and time of addition then click submit."), 
	                      React.createElement("div", {className: "form-group"}, 
							React.createElement(HopBox, {url: "/hops", submitUrl: "/hops/new", pollInterval: 2000}), ";"
	                      )
	                  )
	              )
	          ), 
			  React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-xs-11"}, 
	                  React.createElement("div", {className: "well"}, 
	                      React.createElement("h3", null, "Grains"), 
	                      React.createElement("span", {className: "help-block"}, "Enter the grain type, and amount then click submit."), 
	                      React.createElement("div", {className: "form-group"}, 
							React.createElement(YeastBox, {url: "/grains", submitUrl: "/grains/new", pollInterval: 2000}), ";"
	                      )
	                  )
	              )
	          ), 
			  React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-xs-11"}, 
	                  React.createElement("div", {className: "well"}, 
	                      React.createElement("h3", null, "Yeasts"), 
	                      React.createElement("span", {className: "help-block"}, "Enter the yeast type, and amount then click submit."), 
	                      React.createElement("div", {className: "form-group"}, 
							React.createElement(YeastBox, {url: "/yeasts", submitUrl: "/yeasts/new", pollInterval: 2000}), ";"
	                      )
	                  )
	              )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var HopList = __webpack_require__(4)
	var HopForm = __webpack_require__(5)
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {className: "hopBox"}, 
	        React.createElement(HopList, {data: this.state.data}), 
	        React.createElement(HopForm, {onHopSubmit: this.handleHopSubmit})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var GrainList = __webpack_require__(8)
	var GrainForm = __webpack_require__(9)
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {className: "grainBox"}, 
	        React.createElement(GrainList, {data: this.state.data}), 
	        React.createElement(GrainForm, {onGrainSubmit: this.handleGrainSubmit})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var YeastList = __webpack_require__(6)
	var YeastForm = __webpack_require__(7)
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {className: "yeastBox"}, 
	        React.createElement(YeastList, {data: this.state.data}), 
	        React.createElement(YeastForm, {onYeastSubmit: this.handleYeastSubmit})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var Hop = __webpack_require__(11)

	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    var hopNodes = this.props.data.map(function (hop) {
	      return (
	        React.createElement(Hop, {type: hop.Type, amount: hop.Amount, dimension: hop.Dimension, timeofaddition: hop.TimeOfAddition}
	        )
	      );
	    });
	    return (
	      React.createElement("div", {className: "container"}, 
		    React.createElement("div", {className: "row"}, 
		      React.createElement("table", {className: "hopList table"}, 
		        React.createElement("tr", null, 
		          React.createElement("th", null, "Variety"), 
		          React.createElement("th", null, "Amount"), 
				  React.createElement("th", null, "Measurement"), 
				  React.createElement("th", null, "Time of Addition")
		        ), 
		        hopNodes
		      )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("form", {className: "hopForm", onSubmit: this.handleSubmit}, 
		    React.createElement("div", {className: "container"}, 
			  React.createElement("div", {className: "row"}, 
			    React.createElement("div", {className: "col-xs-4"}, 
			      React.createElement("input", {type: "text", className: "form-control", placeholder: "Variety", ref: "type"})
				), 
				React.createElement("div", {className: "col-xs-2"}, 
			      React.createElement("input", {type: "text", className: "form-control", placeholder: "Amount", ref: "amount"})
				), 
				React.createElement("div", {className: "col-xs-2"}, 
				  React.createElement("select", {className: "form-control", ref: "dimension"}, React.createElement("option", null, "Ounces"), React.createElement("option", null, "Pounds"))
				), 
				React.createElement("div", {className: "col-xs-2"}, 
				  React.createElement("input", {type: "text", className: "form-control", placeholder: "Time of Addition", ref: "timeofaddition"})
				), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var Yeast = __webpack_require__(12)

	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    var yeastNodes = this.props.data.map(function (yeast) {
	      return (
	        React.createElement(Yeast, {type: yeast.Type, amount: yeast.Amount, dimension: yeast.Dimension}
	        )
	      );
	    });
	    return (
	      React.createElement("div", {className: "container"}, 
		    React.createElement("div", {className: "row"}, 
		      React.createElement("table", {className: "yeastList table"}, 
		        React.createElement("tr", null, 
		          React.createElement("th", null, "Variety"), 
		          React.createElement("th", null, "Amount"), 
				  React.createElement("th", null, "Measurement")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("form", {className: "yeastForm", onSubmit: this.handleSubmit}, 
		    React.createElement("div", {className: "container"}, 
			  React.createElement("div", {className: "row"}, 
			    React.createElement("div", {className: "col-xs-4"}, 
			      React.createElement("input", {type: "text", className: "form-control", placeholder: "Variety", ref: "type"})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(10);
	var Grain = __webpack_require__(13)

	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    var grainNodes = this.props.data.map(function (grain) {
	      return (
	        React.createElement(Grain, {type: grain.Type, amount: grain.Amount, dimension: grain.Dimension}
	        )
	      );
	    });
	    return (
	      React.createElement("div", {className: "container"}, 
		    React.createElement("div", {className: "row"}, 
		      React.createElement("table", {className: "grainList table"}, 
		        React.createElement("tr", null, 
		          React.createElement("th", null, "Variety"), 
		          React.createElement("th", null, "Amount"), 
				  React.createElement("th", null, "Measurement")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("form", {className: "grainForm", onSubmit: this.handleSubmit}, 
		    React.createElement("div", {className: "container"}, 
			  React.createElement("div", {className: "row"}, 
			    React.createElement("div", {className: "col-xs-4"}, 
			      React.createElement("input", {type: "text", className: "form-control", placeholder: "Variety", ref: "type"})
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    ...
	    return (
		  React.createElement("tr", {className: "hop"}, 
	        React.createElement("td", null, this.props.type), 
	        React.createElement("td", null, this.props.amount), 
			React.createElement("td", null, this.props.dimension), 
			React.createElement("td", null, this.props.timeofaddition)
		  )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    ...
	    return (
		  React.createElement("tr", {className: "yeast"}, 
	        React.createElement("td", null, this.props.type), 
	        React.createElement("td", null, this.props.amount), 
			React.createElement("td", null, this.props.dimension)
		  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  render: function() {
	    ...
	    return (
		  React.createElement("tr", {className: "grain"}, 
	        React.createElement("td", null, this.props.type), 
	        React.createElement("td", null, this.props.amount), 
			React.createElement("td", null, this.props.dimension)
		  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flattenChildren = __webpack_require__(41);
	var instantiateReactComponent = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerReactRootIndex = __webpack_require__(58);
